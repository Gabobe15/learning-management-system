# Generated by Django 4.2.7 on 2024-08-07 16:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('language', models.CharField(choices=[('English', 'English'), ('Kiswahili', 'Kiswahili'), ('Arabic', 'Arabic')], default='English', max_length=100)),
                ('level', models.CharField(choices=[('Beginners', 'Beginners'), ('Intermediate', 'Intermediate'), ('Advanced', 'Advanced')], default='Beginner', max_length=100)),
