...
class CourseListAPIView(generics.ListAPIView):
    ...
    serializer_class = api_serializer.CourserSerializer
    permission_classes = [AllowAny]
...
class CourseDetailAPIView(generics.RetrieveAPIView):
    ...
    def get_object(self):
        ...
        course = api_models.Course.objects.filter(slug=slug, platform_status="Published", teacher_course_status="Published")
        return course
...
class CreateOrderAPIView(generics.CreateAPIView):
    serializer_class = api_serializer.CartOderSerializer
    permission_classes = [AllowAny]
    queryset = api_models.CartOder.objects.all()
    ...
    def create(self, request, *args, **kwargs):
        ...
        order = api_models.CartOder.objects.create(
            full_name=full_name,
            email=email,
            country=country,
            student=user
