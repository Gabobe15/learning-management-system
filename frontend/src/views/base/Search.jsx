...
// this package is use for rating
  ...
  const handleSearch = (e) => {
		...
		if (query === '') {
			...
			const course = courses.filter((course) => {
				...
				); // it will convert title to lowercase and look return data it is included in the search input --includes(query)
			});
			setCourses(course);
		}
	};
						...
						<div className="row">
							<div className="col-lg-6">
								<input
									...
									onChange={handleSearch} // another way of doing it.
								/>
							</div>
						</div>
					</div>
					<div className="row">
						<div className="col-md-12">
							<div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
								{/* add cources here from index.jsx  */}
