...
function Coupon() {
	const [coupons, setCoupons] = useState([]); // retrieve
	const [createCoupon, setCreateCoupon] = useState({ code: '', discount: 0 }); //create
	const [selectedCoupon, setSelectedCoupon] = useState([]); //update
	...
	const handleCreateCouponChange = (e) => {
		setCreateCoupon({
			...createCoupon,
	...
	const handleCouponSubmit = (e) => {
		...
		formdata.append('teacher', UserData()?.user_id);
